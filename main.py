...
[FF0000]╠══════════╣
[FFD700]⚡ OWNER : [FFFFFF]Mr.Ghost    
[FFD700]✨ Name on tiktok : [FFFFFF] 9x_jubayer_❤️  
[FF0000]╚══════════╝
[FFD700]✨ Developer —͟͞͞ </> Mr.Ghost ❄️  ⚡
"""
                        ...
                        if inPuTMsG.strip().startswith('/room'):
                            ...
                            if len(parts) < 2:
                                ...
                                try:
                                    ...
                                    # Create spam packet
                                    spam_packet = await Room_Spam(target_uid, room_id, "Mr.Ghost", key, iv)
...
# IMPROVED TREE-STYLE HELP MENU SYSTEM (Commands in their original menus) 🌳
                        if inPuTMsG.strip().lower() in ("help", "/help", "menu", "/menu", "commands"):
                            ...
                            # Header
                            header = f"[b][c]{get_random_color()}Hey User Welcome To ᴹᴿ᭄ɢʜᴏsT B O T"
...
[00FFFF]━━━━━━━━━━━━[FF69B4]"""
                            ...
                            # ───── Advanced Commands ─────
                            advanced_commands = """[C][B][800080]═══⚡ ADVANCED COMMANDS ⚡═══[00BFFF][B]
...
[00BFFF]━━━━━━━━━━━━[BA55D3]"""
                            ...
                            # ───── Emote Commands ─────
                            emote_commands = """[C][B][32CD32]═══⚡ EMOTE COMMANDS ⚡═══[00BFFF][B]
├─ [00BFFF]Send Single Emote
│  └─ [32CD32]/e [uid] [id]
├─ [00BFFF]Fast Emote (25x)
│  └─ [32CD32]/fast [uid] [id]
└─ [00BFFF]Custom Emote (X times)
   └─ [32CD32]/p [uid] [id] [x]
[00BFFF]━━━━━━━━━━━━[32CD32]"""
                            ...
                            evo_commands = """[C][B][FFA500]═══⚡ EVOLUTION EMOTES ⚡═══[00BFFF][B]
...
├─ [00BFFF]Auto Cycle All Evo Emotes
│  └─ [FFA500]/random [uid]
...
[00BFFF]━━━━━━━━━━━━[FFA500]"""
                            ...
                            # ───── AI & Utility Commands ─────
                            ai_commands = """[C][B][1E90FF]═══⚡ TOOLS & FUN COMMANDS ⚡═══[00BFFF][B]
├─ [00BFFF]Get player bio by uid
│  └─ [FFFFFF]/bio [uid]
├─ [00BFFF]Fetch Instagram User Info
│  └─ [FFFFFF]/ig [username]
├─ [00BFFF]Send custom spam message
│  └─ [FFFFFF]/ms <text>
...
[00BFFF]━━━━━━━━━━━━[1E90FF]"""
                            ...
                            # ───── Badges Commands ─────
                            badge_commands = """[C][B][FF4500]═══⚡ BADGE JOIN REQUESTS ⚡═══[00BFFF][B]
...
│  └─ [FF4500]/s3 [uid]
├─ [00BFFF]Join Req Small V-Badge
│  └─ [FF4500]/s4 [uid]
├─ [00BFFF]Join Req Pro Badge
│  └─ [FF4500]/s5 [uid]
...
[00BFFF]━━━━━━━━━━━━[FF4500]"""
                            ...
                            await asyncio.sleep(0.2)
                                                        ...
                                                        # ───── Auto Start Commands ─────
                            auto_commands = """[C][B][FF00FF]═══⚡ ADMIN INFO ⚡═══[FF1493][B]
├─ [FF1493]OWNER JUBAYER
│  └─ [FF00FF]OWNER UID: 5791471936
└─ [FF1493]YOUTUBE
   └─ [FF00FF]Mr.ghost
[FF1493]━━━━━━━━━━━━[FF00FF]"""
...
[00FFFA]║
[FFFF00]║ 👤 Developer    :: [FF1493]Mr.Ghost
[32CD32]║ 💻 Status        :: [32CD32]ONLINE
[1E90FF]║ 🛠 Version      :: [1E90FF]Ghost V2
[00FFFA]╚═•══•════════════════•══•═╝"""
...
async def MaiiiinE():
    Uid , Pw = "4360206267","0EF679B8229EECD1D7C21486D8F44752CF6DF76E52B53260D89FA021A9FC67F2"
    ...
    os.system('clear')
    print("Initializing Mr.Ghost Bot...")
    print("┌────────────────────────────────────┐")
    print("│ SUBSCRIBER ON │")
    print("└────────────────────────────────────┘")
    time.sleep(0.5)
    ...
    print("Connecting to Free Fire servers...")
    print("┌────────────────────────────────────┐")
    print("│ SUBSCRIBER ON YOUTUBE  │")
    print("└────────────────────────────────────┘")
    time.sleep(0.5)
    os.system('clear')

    print("🤖 Mr.Ghost BOT - ONLINE")
    print("┌────────────────────────────────────┐")
    print("│ SUBSCRIBER  ON  YOUTUBE  : MR.GHOST │")
    print("└────────────────────────────────────┘")
    print(f"🔹 UID: {TarGeT}")
    ...
    os.system('clear')
    print(render('Mr.Ghosts', colors=['white', 'green'], align='center'))
    print('')
    print("🤖 Mr Ghost Bot - ONLINE")
    print(f"🔹 UID: {TarGeT}")
    print(f"🔹 Name: {acc_name}")
...
def handle_keyboard_interrupt(signum, frame):
    ...
    print("👋 Thanks for using Mr.Ghost")
    sys.exit(0)
